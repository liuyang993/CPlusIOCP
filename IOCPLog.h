...
#include "Prerequisites.h"
    ...
    */
	...
	public:
        ...
        */
        virtual void messageLogged( const CString& message, LogMessageLevel lml, bool maskDebug, const CString &logName, bool& skipThisMessage ) = 0;
    };
    ...
    */
    ...
    protected:
        ...
        bool			mDebugOut;
        bool			mSuppressFile;
        bool			mTimeStamp;     //TimeStamp 为什么是 bool 型
        std::string			mLogName;
